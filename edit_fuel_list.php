...
<ul>
	...
	<?php foreach($fuels as $fuel) : ?> <!-- Foreach statement that gets the data from the database and fills the table with that data -->
	<tr>
		...
		<td>
		<form action = "edit_data/edit_fuel_form.php" method="post" id="edit_fuel">
		<input type="hidden" name="fuel_id" value="<?php echo $fuel['fuel_id']; ?>">
		<input type="submit" value="Edit Fuel">
		</form>
		</td>
