...
$query= 'INSERT INTO maintenance (maintenance_type_id, vehicle_id, maintenance_vendor, maintenance_description, maintenance_vendor_address, maintenance_cost, maintenance_mileage, maintenance_date, maintenance_date_modified) VALUES (:maintenance_type_id, :vehicle_id, :maintenance_vendor, :maintenance_description, :maintenance_vendor_address, :maintenance_cost, :maintenance_mileage, :maintenance_date, now())';
