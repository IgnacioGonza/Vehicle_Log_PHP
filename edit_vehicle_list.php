...
<ul>
	...
	<?php foreach($vehicles as $vehicle) : ?> <!-- Foreach statement that gets the data from the database and fills the table with that data -->
	<tr>
		...
		<td>
		<form action = "edit_data/edit_vehicle_form.php" method="post" id="edit_vehicle">
