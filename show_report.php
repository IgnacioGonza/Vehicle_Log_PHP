...
<h2>Vehicle Information:</h2>
	...
	<?php foreach($vehicles as $vehicle) : ?> <!-- A foreach statement for getting the data from the database and filling the table -->
	<tr>
...
<h2>Maintenances for the vehicle:</h2>
	...
	<?php foreach($maintenances as $maintenance) : ?> <!-- A foreach statement for getting the data from the database and filling the table -->
	<tr>
...
<h2>Fuels used:</h2>
	...
	<?php foreach($fuels as $fuel) : ?> <!-- A foreach statement for getting the data from the database and filling the table -->
	<tr>
