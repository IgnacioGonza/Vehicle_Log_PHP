...
<ul>
	...
	<?php foreach($maintenances as $maintenance) : ?> <!-- Foreach statement that gets the data from the database and fills the table with that data -->
	<tr>
		...
		<td>
		<form action = "edit_data/edit_maintenance_form.php" method="post" id="edit_maintenance">
